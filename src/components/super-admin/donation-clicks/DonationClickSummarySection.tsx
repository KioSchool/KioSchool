import { RiCursorLine, RiMoneyDollarCircleLine, RiPercentLine, RiReceiptLine } from '@remixicon/react';
...
function DonationClickSummarySection({ summary }: DonationClickSummarySectionProps) {
  return (
    <Section>
      ...
      <StatGrid>
        ...
        <StatCard
          ...
          footer={
            <Caption>
              고유 주문 {formatNumber(summary.uniqueOrders)} / 취소 제외 주문 {formatNumber(summary.ordersInRange)}건 · 모달 재노출 제한이 있어 실제 노출
              대비보다 낮게 나옵니다
            </Caption>
          }
        />
