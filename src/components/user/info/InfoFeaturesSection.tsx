...
const FEATURES = [
  {
    ...
    title: 'QR 주문',
    description:
      '손님이 테이블에서 QR을 스캔하면 메뉴를 보고 바로 주문합니다. 별도의 키오스크 장비 없이, 주문을 받으러 다닐 필요 없이 모든 주문을 처리할 수 있습니다.',
  },
  {
    number: '02',
    title: '실시간 주문 관리',
  ...
  },
  {
    ...
    title: '테이블 관리',
    description:
      '테이블 수만 입력하면 QR 코드가 자동 생성됩니다. 출력해서 테이블에 붙이기만 하면 바로 운영을 시작할 수 있습니다. 테이블 추가나 삭제도 간단합니다.',
  },
];
