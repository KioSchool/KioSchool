...
const FEATURES = [
  {
    ...
    title: 'QR 주문',
    description:
      '손님이 테이블에서 QR을 스캔하면 메뉴를 보고 바로 주문합니다. 별도의 키오스크 장비 없이, 주문을 받으러 다닐 필요 없이 스마트폰 하나로 모든 주문을 처리할 수 있습니다.',
  },
  {
    number: '02',
    title: '실시간 주문 관리',
    description:
      '주문이 들어오면 운영자 화면에 바로 표시됩니다. 주문 상태를 실시간으로 관리하고, 놓치는 주문 없이 서빙할 수 있습니다. 테이블별 주문 현황을 한눈에 파악하세요.',
  },
  {
    number: '03',
    title: '자동 정산',
    description:
      '테이블별, 메뉴별 매출이 자동으로 집계됩니다. 축제가 끝나면 클릭 한 번으로 정산 결과를 확인할 수 있습니다. 더 이상 엑셀로 수동 정산할 필요가 없습니다.',
  },
  {
    number: '04',
    title: '테이블 관리',
    description:
      '테이블 수만 입력하면 QR 코드가 자동 생성됩니다. 출력해서 테이블에 붙이기만 하면 바로 운영을 시작할 수 있습니다. 테이블 추가나 변경도 간단합니다.',
  },
];
