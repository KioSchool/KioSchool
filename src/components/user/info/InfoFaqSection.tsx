...
const FAQ_DATA = [
  {
    question: '비용이 있나요?',
    answer: '키오스쿨은 무료로 사용할 수 있습니다. 별도의 장비나 구독료 없이 시작하세요.',
  },
  {
    question: '결제 시스템은 어떻게 되나요?',
    answer: '키오스쿨은 주문 접수와 관리에 집중하는 서비스입니다. 결제는 기존 방식(현금, 계좌이체 등)을 그대로 사용하시면 됩니다.',
  },
  {
  ...
  },
  {
    ...
    answer: '운영 중 문제가 발생하면 카카오톡 채널을 통해 실시간으로 문의하실 수 있습니다.',
  },
];
