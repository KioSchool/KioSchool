...
function AddWorkspaceModalContent({ workspaceDescriptionRef, workspaceNameRef }: Props) {
  return (
    <>
      <AppInputWithLabel titleLabel={'가게 이름'} style={{ marginBottom: '25px' }} type={'text'} id={'workspaceName'} ref={workspaceNameRef} />
      <AppInputWithLabel titleLabel={'가게 설명'} style={{ marginBottom: '20px' }} type={'text'} id={'workspaceDescription'} ref={workspaceDescriptionRef} />
