...
import { OrderStatus, PaginationResponse, SuperAdminOrder } from '@@types/index';
  ...
  return (
    <AppContainer useFlex={colFlex({ align: 'center' })} backgroundColor={Color.LIGHT_GREY} useTitle={false}>
      <PageContainer>
        ...
        <FilterBar>
          <FilterInput type="number" placeholder="워크스페이스 ID" value={workspaceIdFilter} onChange={(e) => setWorkspaceIdFilter(e.target.value)} />
